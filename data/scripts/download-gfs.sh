...
# Partitioned swell is deliberately NOT downloaded here: the map slider and
# spot panel only cover 0-168h; extended hours feed the "score next week"
# scoring, which stays on the combined field.
